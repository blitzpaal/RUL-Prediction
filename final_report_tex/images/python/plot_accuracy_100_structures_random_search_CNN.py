...
with open('C:/Users/pajo8/RUL Prediction/CNN_Model1_3/100_structures_randomSearch_9/postprocessing/run-a44e7c007603279dfb3e81ade853bbab_execution0_train-tag-epoch_sparse_categorical_accuracy.csv', newline='') as csvfile:
    ...
    next(reader)
    for row in reader:
        structures_5_training[0].append(int(row[1]))
        structures_5_training[1].append(float(row[2]))
...
with open('C:/Users/pajo8/RUL Prediction/CNN_Model1_3/100_structures_randomSearch_5/postprocessing/run-7e8000fe71b5416675827b5b1d399584_execution0_train-tag-epoch_sparse_categorical_accuracy.csv', newline='') as csvfile:
    ...
    next(reader)
    for row in reader:
        structures_40_training[0].append(int(row[1]))
        structures_40_training[1].append(float(row[2]))
...
ax.plot(structures_5_training[0], structures_5_training[1], linestyle='--', linewidth=0.75, marker='', color='k', label='Training')
...
plt.savefig('accuracy_100_structures_random_search_5_CNN.pdf', bbox_inches='tight')
plt.show()
...
plt.savefig('accuracy_100_structures_random_search_10_CNN.pdf', bbox_inches='tight')
plt.show()
...
plt.savefig('accuracy_100_structures_random_search_15_CNN.pdf', bbox_inches='tight')
plt.show()
...
plt.savefig('accuracy_100_structures_random_search_20_CNN.pdf', bbox_inches='tight')
plt.show()
...
plt.savefig('accuracy_100_structures_random_search_30_CNN.pdf', bbox_inches='tight')
plt.show()

fig, ax = plt.subplots(figsize=(4,3))

ax.plot(structures_40_training[0], structures_40_training[1], linestyle='--', linewidth=0.75, marker='', color='k', label='Training')
...
plt.savefig('accuracy_100_structures_random_search_40_CNN.pdf', bbox_inches='tight')
plt.show()