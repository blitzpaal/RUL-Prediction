...
\title{Remaining Useful Life Prediction With Deep Learning Methods}
...
With the increasing availability of data for \gls{phm} data driven approaches become more and more interesting. Deep Learning is one of these approaches. As Deep Learning has shown great success in other domains such as \gls{nlp} and image classification it is a promising prospect for \gls{phm}.
...
Both the \gls{gru} and \gls{tcn} models show a validation accuracy of greater than 95\% when trained on 500 or 1000 structures. But the \gls{tcn} outperforms all other models on the testing dataset where it reaches 100\% accuracy after being trained on 1000 structures.
...
\begin{figure}[htp]
	\centering
	\subfloat[][]{\includegraphics[width=0.45\textwidth]{classification_model.pdf}}
	\\
