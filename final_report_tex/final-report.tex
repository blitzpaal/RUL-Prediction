...
% ADD MORE DETAILS ON THE DATASET HERE
...
% WHAT KIND OF PREDICTION IS EXPECTED FROM THE MODEL?
...
% Explanation of classification and preparation of dataset
...
% Add details on the explenation of the Deep Learning models
...
% Given an overview of the used evaluation metrics and why they are used

% Details on the hyperparameter optimization strategies (how the models are trained and how their parameters are optimised)

\section{Results}
\label{sec:results}

% Show the used model architectures for rnn and cnn and why they are used

% Give an overview of the results of the hyperparameter optimisation strategies for the rnn and cnn networks

% Show the detailed results of some networks with more detailed evaluation metrics

% Compare the rnn and cnn results
