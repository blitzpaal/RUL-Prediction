...
\begin{table}[htp]
	...
	\begin{tabular}{lllllll}
		$ \boldmath{t} $ & $ \boldmath{ID} $ & $ \boldmath{cycle} $ & $ \boldmath{\epsilon_1} $     & $ \boldmath{\epsilon_2} $     & $ \boldmath{\epsilon_3} $     & $ \boldmath{RUL_{bin}} $   \\
		\hline
...
\begin{figure}[htp]
	\centering
	\subfloat[][]{\includegraphics[width=0.2\textwidth]{tcn_block.pdf}}
	\qquad
	\subfloat[][]{\includegraphics[width=0.2\textwidth]{tcn_block_example.pdf}}
...
\begin{table}[htp]
	...
	\begin{tabular}{ll}
		\boldmath{Parameter} & \boldmath{Value} \\
		\hline
		Batch size & $ 4096 $ \\
...
\begin{table}[htp]
	...
	\begin{tabular}{ll}
		\boldmath{Parameter} & \boldmath{Value set} \\
		\hline
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{python/influence_sequence_length.pdf}
...
Table \ref{tab:hyperparameters_100_structures} shows the different architectures form the hyperparameter optimization that achieved the best results with the respective sliding window length on $ 100 $ training structures.
...
\begin{table}[htp]
	...
	\begin{tabular}{lllllll}
		...
		Learning rate & $ 10^{-2} $ & $ 10^{-2} $ & $ 10^{-2} $ & $ 10^{-2} $ & $ 10^{-2} $ & $ 3 $ \\
		\hline
		Validation accuracy & $ 0.6984 $ & $ 0.7063 $ & $ 0.7090 $ & $ 0.7139 $ & $ 0.7239 $ & $ 0.7335 $
	\end{tabular}
\end{table}
