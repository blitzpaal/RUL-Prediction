...
\begin{table}[htp]
	...
	\begin{tabular}{p{2.5cm}|lll}
		...
		\hline
		Validation accuracy & $0.898$ & $0.850$ & $0.783$\\
		\hline
		Testing accuracy & $0$ & $0$ & $0$
	\end{tabular}
\end{table}
...
\begin{table}[htp]
	...
	\begin{tabular}{p{2.5cm}|lll}
		...
		Type of architecture & \gls{rnn} & \gls{lstm} & \gls{gru}\\
		\hline
		Validation accuracy & $0.924$ & $0.861$ & $0.970$\\
		\hline
		Testing accuracy & $0$ & $0$ & $0$
	\end{tabular}
\end{table}
