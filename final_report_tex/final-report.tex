...
The provided datasets were separated in two distinguished parts, namely training and testing dataset. The first consists in 10,000 structures with different initial crack lengths. Most of the models were trained on this dataset using only a part of it, respectively $ 100 $, $ 500 $ and $ 1000 $ structures. While training, the last $ 100 $ structures of the training dataset were used as a validation dataset.
...
\begin{table}[htp]
	\centering
	\caption{Variable parameters for \gls{rnn} hyperparameter optimization}
